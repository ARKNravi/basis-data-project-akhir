...
public class Form_Barang extends javax.swing.JPanel {
         ...
         */
        public Form_Barang(Connection conn, String os) {
                this.conn = conn;
                initComponents(os);
         ...
         */
        private void loadTableData(Connection conn) {
                try {
                        ...
                        ReadBarang.bacaBarang(conn, model);
        ...
        private void initComponents(String os) {
                ...
                button_search_barang.addMouseListener(new java.awt.event.MouseAdapter() {
                        public void mouseClicked(java.awt.event.MouseEvent evt) {
                                button_search_barangMouseClicked(evt, conn);
                        }
                });
                                                                                ...
                                                                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                                                                                dataBarangLayout
                                                                                                                ...
                                                                                                                .addGroup(dataBarangLayout
                                                                                                                                ...
                                                                                                                                .addGroup(dataBarangLayout
                                                                                                                                                .createSequentialGroup()
                                                                                                                                                .addComponent(tambahBarang_button2,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                                190,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                                .addPreferredGap(
                                                                                                                                                                javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                                                                                                                .addComponent(tambahBarang_button,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                                190,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                                .addGap(12, 12, 12)
                                                                                                                                                .addComponent(tambahBarang_button1,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                                                                                                190,
                                                                                                                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                                                                                                .addPreferredGap(
                ...
                Gudang_comboBox
                                .setModel(new javax.swing.DefaultComboBoxModel<>(
                                                new String[] { "Offlen", "Shopee", "Tokopedia" }));
        ...
        private void button_search_barangMouseClicked(java.awt.event.MouseEvent evt, Connection conn) {
                // Get the keyword from a JTextField (replace "yourTextField" with the actual
                // variable name)
                ...
                try {
                        ...
                        DefaultTableModel model = Search.barang(conn, keyword);
                        ...
                        JOptionPane.showMessageDialog(null,
                                        "Failed to search for items. Please check your inputs and try again.");
                }
        }
        ...
        private void simpan_button1MousePressed(java.awt.event.MouseEvent evt) {
                ...
                try {
                        ...
                        UpdateBarang.updateBarang(conn, kodeBarang, namaBarang.isEmpty() ? null : namaBarang, ukuranBarang,
                                        gudang, stok);
                        ...
                        e.printStackTrace();
                        JOptionPane.showMessageDialog(null,
                                        "Failed to update barang. Please check your inputs and try again.");
                }
        }
        ...
        private void tambahBarang_button1ActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (selectedRowIndex != -1) {
                        ...
                        try {
                                ...
                                DeleteBarang.deleteBarang(conn, realId);
