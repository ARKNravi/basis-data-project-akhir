...
public class Form_Transaksi extends javax.swing.JPanel {
    ...
    private void button_searchMousePressed(java.awt.event.MouseEvent evt) throws SQLException {
        ...
        while (rs.next()) {
            ...
            int ukuran = rs.getInt("ukuran");
            int jumlah = rs.getInt("jumlah");
            int total_harga = rs.getInt("total_harga");
            int tanggal_transaksi = rs.getInt("tanggal_transaksi");
            int metode_pembelian = rs.getInt("metode_pembelian");

            // Add a row to the model
            model.addRow(new Object[]{no_nota, kode_barang, ukuran, jumlah,total_harga,tanggal_transaksi,metode_pembelian});
        }
        tableDataTransaksi.setModel(model);
    }
