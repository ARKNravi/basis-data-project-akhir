...
public class Form_Transaksi extends javax.swing.JPanel {
    ...
    private void setTransactionsTableModel(Connection conn) {
        DefaultTableModel model = ReadTransaksi.getTransactionsTableModel(conn);
     ...
     */
    public Form_Transaksi(Connection conn, String os) {
        this.conn = conn;
        initComponents(os);
        ...
        setTransactionsTableModel(conn);
    }
    ...
    private void batal_button1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!kodeBarangText.isEmpty() && !jumlahBarangText.isEmpty()) {
            ...
            try {
                // Query the barang and stok_barang tables to get the harga_barang and available
                // stock
                ...
                if (resultSet.next()) {
                    ...
                    if (availableStock >= jumlahBarang) {
                        ...
                        JOptionPane.showMessageDialog(null, "Not enough stock available.", "Warning",
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    Transaksi transaksi = new Transaksi(conn);
                    int total_barang = 1;
                    int total_harga = 0;
                    if (currentNota == -1) {
                    ...
                    query = "UPDATE stok_barang SET " + beliDimana.toLowerCase() + " = " + beliDimana.toLowerCase()
    ...
    public void updateTable(int no_nota) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = conn.prepareStatement(query, ResultSet.TYPE_SCROLL_INSENSITIVE,
    ...
    private void button_searchMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            ...
            DefaultTableModel model = Search.nota(conn, keyword);
            ...
            JOptionPane.showMessageDialog(null,
                    "Failed to search for transactions. Please check your inputs and try again.");
        }
    }
