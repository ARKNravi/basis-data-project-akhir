...
public class coba {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //     if (kode.equals("0"))
            //         break;
            //     kode_barang = Integer.parseInt(kode.replace('P', '0'));
            ...
            //     if (total_barang == 0) {
            //         CreateBarang.insertNota(conn, 0, 0, "OF");
            //     }
            //     total_barang += jumlah_barang;
            //     total_harga += ReadBarang.bacaHargaBarang(conn, kode_barang) * jumlah_barang;
            // }
            // System.out.print("""
            //     1. Offline\t(OF)
            //     2. Shopee\t(SP)
            ...
            //     CreateTransaksi.insertTransaksi(conn, kode_barang, ukuran, jumlah_barang, metode,total_barang,total_harga);
